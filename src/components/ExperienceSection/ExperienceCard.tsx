    ...
    >
      <div className="flex items-start">
        <div className="flex-none">
          <span className="relative flex shrink-0 overflow-hidden rounded-full border-[0.5px]  border-accent size-12 m-auto bg-muted-background dark:bg-foreground">
            <img
              src={logo}
              alt={`${company} logo`}
        ...
        <div className="flex-grow ml-4 items-start flex-col group">
          <div className="flex flex-col">
            ...
            <div className="font-sans text-xs text-primary">{position}</div>
          </div>
          <div
            className={`text-primary overflow-hidden transition-all duration-700 ease-in-out ${
