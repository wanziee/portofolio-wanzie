...
function StickyBottomNavigationBar() {
  return (
    <DynamicDock gapX={4} baseWidth={32}>
      ...
      <div className="w-[2px] h-2 bg-gray-300"></div>
      <div className="dock-item flex items-center justify-center relative group">
        <button className="w-9 h-9 rounded-full hover:bg-accent-dock  flex items-center justify-center transition-colors">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="15"
            height="15"
            fill="currentColor"
            className="bi bi-moon-stars scale-x-[-1] text-primary font-light"
            viewBox="0 0 16 16"
            stroke="currentColor"
          >
