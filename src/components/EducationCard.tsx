    ...
    >
      <div className="flex items-start">
        <div className="flex-none">
          <span className="relative flex shrink-0 overflow-hidden rounded-full border border-gray-200 size-12 m-auto bg-muted-background dark:bg-foreground">
            <img
              src={logo}
        ...
        <div className="flex-grow ml-4 items-start flex-col group">
          <div className="flex flex-col">
            <div className="flex items-center justify-between gap-x-2 text-base">
              ...
              <span className="ml-auto text-sm text-gray-700 dark:text-gray-500">
                {date}
              </span>
            </div>
            <div className="font-sans text-xs">{certificate}</div>
          </div>
          <div
