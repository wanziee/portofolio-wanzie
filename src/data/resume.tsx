  ...
  projects: [
    {
      ...
      technologies: ["Laravel", "Php", "Midtrans API"],
      links: [
        {
          type: "Github",
    ...
    dates: "July 2025",
    description:
      "CoinTrek is a cryptocurrency tracker app built with SwiftUI that integrates the CoinGecko API to display real-time prices, charts, and market data.",
    technologies: ["Swift", "SwiftUI", "CoinGecko API"],
    links: [
      {
        type: "Github",
        href: "https://github.com/wanziee/CoinTrek",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="13"
    ...
    description:
      "Cepat Tanggap is a citizen reporting app that allows users to submit reports, track status, and receive responses from admins in real-time.",
    technologies: ["Swift","SwiftUI", "Node.js", "Express", "Sequelize", "React", "RESTful API"],
    links: [
      {
        type: "Github",
        href: "https://github.com/wanziee/cepat-tanggap-frontend",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="13"
